...
@EnableWs
@Configuration
public class WebServiceConfigCo extends WsConfigurerAdapter {
	@Bean
	public ServletRegistrationBean messageDispatcherServlet2(ApplicationContext applicationContext) {
		...
		servlet2.setApplicationContext(applicationContext);
		servlet2.setTransformWsdlLocations(true);
		return new ServletRegistrationBean(servlet2, "/ws/*");
	}
